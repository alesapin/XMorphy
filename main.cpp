...
int main(int argc, char **argv) {
  ...
  desc.add_options()("input,i", po::value<string>(), "set input file")(
      "output,o", po::value<string>(), "set output file")(
      "newline,n", "new line mode")("disamb,d", "disambiguate")("phem,p",
                                                                "phemise")(
      "mpath", po::value<string>()->default_value(defMPath),
      "models folder path")("dpath",
                            po::value<string>()->default_value(defDPath),
                            "dicts folder path");
  po::variables_map vm;
