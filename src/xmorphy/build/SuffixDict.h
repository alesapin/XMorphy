...
public:
    ...
    ParaPairArray getCandidates(const utils::UniString & word, std::vector<size_t> & tailsLens, const std::unordered_map<size_t, size_t> & suffixes_length, bool longest = false) const;
