...
public:
    ...
    static std::vector<RusCorpMorphTag>::const_iterator begin() {
        return inner_runner.begin();
    }

    static std::vector<RusCorpMorphTag>::const_iterator end() {
