...
static const boost::bimap<uint64_t, std::string> ANALYZER_TAG_MAP =
    boost::assign::list_of<boost::bimap<uint64_t, std::string>::relation>(0, "UNKN")(ONE << 0, "DICT")(ONE << 1, "PREF")(ONE << 2, "SUFF")(ONE << 3, "HYPH");
...
AnalyzerTag::AnalyzerTag(uint64_t val)
...
AnalyzerTag::AnalyzerTag()
    : ITag((uint64_t)0, &ANALYZER_TAG_MAP) {
}
}
