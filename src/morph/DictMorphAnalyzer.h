...
private:
    ...
    ParsedPtr buildByPara(const LexemeGroup& reqForm, const LexemeGroup& givenForm, const LexemeGroup& normalForm, const utils::UniString& given) const;
...
protected:
    ...
    virtual std::vector<ParsedPtr> synthesize(const utils::UniString& str, const UniMorphTag& t, const std::map<Paradigm, std::size_t>& paras) const;
    std::vector<ParsedPtr> synthesize(const utils::UniString& str, const UniMorphTag& given, const UniMorphTag& req, const std::map<Paradigm, std::size_t>& paras) const;
protected:
